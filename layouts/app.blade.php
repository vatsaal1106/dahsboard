...
<body id="body" class="{{ user()->dark_theme ? 'dark-theme' : '' }} {{ isRtl('rtl') }}">
    ...
    <div class="clearfix body-wrapper">
        ...
        <section class="mb-5 main-container bg-additional-grey mb-sm-0" id="fullscreen">
            ...
            <x-app-title class="d-block d-lg-none text-blue-600" :pageTitle="$pageTitle"></x-app-title>
    ...
    <script>
        ...
        function quillMention(atValues, ID) {
            const mentionItemTemplate =
                '<div class="mention-item"> <img src="{image}" class="mr-3 rounded align-self-start taskEmployeeImg">{name}</div>';
         ...
         *
         */
        window.addEventListener('mention-clicked', function({
            value
        }) {
            if (value?.link) {
