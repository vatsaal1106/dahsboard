...
<head>
    ...
    <link type="text/css" media="all" href="{{ mix('css/app.css') }}" rel="stylesheet">
    ...
    <meta name="msapplication-TileImage"
        content="{{ isset($company) ? $company->favicon_url : global_setting()->favicon_url }}">
            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="mb-4 col-12">
                        <img src="{{ isset($company) ? $company->light_logo_url : global_setting()->light_logo_url }}"
                            class="rounded height-35">
                        <div class="mt-2 f-12 text-dark-grey">
                            {{ isset($company) ? $company->company_name : global_setting()->global_app_name }}</div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 f-11 text-dark-grey">
                        &copy; {{ now()->year }} |
                        {{ isset($company) ? $company->company_name : global_setting()->global_app_name }}
                    </div>
                </div>
            </div>
