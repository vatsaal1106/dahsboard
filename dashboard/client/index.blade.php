        ...
        <div class="row">
            ...
            @if (in_array('invoices', user_modules()))
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div
                        class="bg-white p-3 border shadow-md !rounded-lg d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
            ...
            @if (in_array('projects', user_modules()))
                <div class="col-sm-12 col-lg-6 mt-4">
                    <x-cards.data :title="__('modules.dashboard.statusWiseProject')">
                        <x-pie-chart id="task-chart" :labels="$statusWiseProject['labels']" :values="$statusWiseProject['values']" :colors="$statusWiseProject['colors']" height="250"
                            width="300" />
                    </x-cards.data>
                </div>
            @endif
